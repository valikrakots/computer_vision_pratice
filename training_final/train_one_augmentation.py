...
train_data, train_cleaned_data, val_train_data, val_train_cleaned_data = prepare_data.prepare_one_transform('train', 'train_cleaned')
...
json_file = open("models/autoencoder_one_aug.json", "w")
json_file.write(model_json)
json_file.close()
autoencoder.save_weights("autoencoder_one_aug.h5")
