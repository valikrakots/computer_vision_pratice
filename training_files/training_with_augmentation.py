...
def load_images(path):
    ...
    if path == 'train':
        ...
        for image in images2:
            augmented = img_to_array((transform2(image=image)["image"]))
            images.append(augmented)
    else:
        images2 = images.copy()
        for image in images2:
...
train_data3 = train_data_all[288:408]
train_cleaned_data3 = train_cleaned_data_all[288:408]
val_train_data3 = train_data_all[408:]
val_train_cleaned_data3 = train_cleaned_data_all[408:]

train_data = np.concatenate((train_data1, train_data2, train_data3))
train_cleaned_data = np.concatenate((train_cleaned_data1, train_cleaned_data2, train_cleaned_data3))
val_train_data = np.concatenate((val_train_data1, val_train_data2, val_train_data3))
val_train_cleaned_data = np.concatenate((val_train_cleaned_data1, val_train_cleaned_data2, val_train_cleaned_data3))
